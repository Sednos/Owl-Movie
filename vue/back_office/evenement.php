...
?>
<form action="?module=back_office&action=ajouter_evenement" method="post" enctype="multipart/form-data">
    <div class="form-group col-xs-10">
        <input class="form-control" type="text" name="titre" placeholder=" Titre" required><br/>
    <textarea class="form-control" rows="5" type="text" name="contenu" placeholder=" Contenu" required></textarea><br/>
