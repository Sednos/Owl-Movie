            ...
            <div class="filmSeanceWrapper">
                ...
                <div class="filmSeanceSsWrapper">
                    ...
                    <span class="miniBtnRS">
                        <a href="#"><img src="img/picto_Facebook.png" width="15" height="15" alt="Partager sur Facebook"></a>
                        <a href="#"><img src="img/picto_Twitter.png" width="15" height="15" alt="Partager sur Twitter"></a>
                    </span>

                    <h4 class="movieTitle"><span>La planète des singes - les origines</span></h4>

                    <div class="moviePosterWrapper">
                        <img src="img/PhotoSeancePro2.jpg" alt="Titanic">
                    </div>
