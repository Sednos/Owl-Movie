  ...
  <div id="formulairePaiementContainer">
    ...
    <div class="Wrapper960px">
      ...
      <form id="formulaireCB">
        ...
        <input type="radio" name="name" value="mastercard"><img src="assets/img/master_card.png" alt="master-card" />
        <input type="radio" name="name" value="visa electron"><img src="assets/img/visa_electron.png" alt="master-card" />
        <input type="radio" name="name" value="american express"><img src="assets/img/american_express.png" alt="master-card" />
